 ...
 */
    ...
    $this->dbName = 'test-shop'; // database name
    $this->dbUser = 'test'; // database user name
    $this->dbPwd = 'test123'; // database user password
    $this->dbType = 'mysql';
     ...
     */
    $this->captchaKey = 'de5a1162dfcb2dfd73386ce3baf83829';
